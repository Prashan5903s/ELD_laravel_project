<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <a href="<?php echo e(route('transport.dashboard', [request()->lang])); ?>" class="app-sidebar-logo">
                <img alt="Logo" src="<?php echo e(url('assets/media/logos/demo39.svg')); ?>" class="h-25px theme-light-show" />
                <img alt="Logo" src="<?php echo e(url('assets/media/logos/demo39-dark.svg')); ?>"
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(session()->has('ut') && session('ut') == 1): ?>
                        <div class="warning-msg d-flex align-items-center">
                            ...
                            <div class="warning-icon me-2 ms-4">
                                <i class="fas fa-exclamation-triangle" data-bs-toggle="popover"
                                    ...
                                    data-bs-content="You have shadow logged in <?php echo e(auth()->user()->first_name); ?>

                                <?php echo e(auth()->user()->last_name); ?>'s white label
                                account."
                                    style="color: red; font-size: 18px;"></i>
                            </div>
                            <!-- Warning Message -->
                            <div class="warning-message d-sm-block d-none" style="font-size: 13px; color: red;">
                                You have shadow logged in <?php echo e(auth()->user()->first_name); ?>
                            ...
                            <div class="app-navbar-item ms-2">
                                <!--begin::Link-->
                                <a href="<?php echo e(route('tr.user.change', ['SA', 4])); ?>"
            ...
            <div class="app-navbar-item ms-2 ms-lg-6 me-lg-13" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px"
                    ...
                    <?php if(session('avatar')): ?>
                        <img src="<?php echo e(asset('white/' . session('avatar'))); ?>" alt="user" />
                    <?php else: ?>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">
                                    <?php echo e(session('first')); ?> <?php echo e(session('last')); ?>

                                </div>
                                <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"
                                    style="overflow-wrap:anywhere"><?php echo e(session('email')); ?></a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="<?php echo e(route('white-label.profile.index')); ?>" class="menu-link px-5">My Profile</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="<?php echo e(route('white-label.profile.edit')); ?>" class="menu-link px-5">Edit Profile</a>
                    </div>
                    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                        <a href="#" class="menu-link px-5">
                            <span class="menu-title position-relative"><?php echo app('translator')->get('lang.lang'); ?>
                                <?php $__currentLoopData = $lang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(Request()->lang == $langu->Short_name): ?>
                                        <span
                                            class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0"><?php echo e($langu->language_name); ?>

                                            <img class="w-15px h-15px rounded-1 ms-2"
                                                src="<?php echo e(asset('logo/' . $langu->logo)); ?>" alt="<?php echo e($langu->language_name); ?>" />
                                    <?php endif; ?>
                        ...
                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                            ...
                            <?php $__currentLoopData = $lang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="menu-item px-3">
                                    <a href="<?php echo e(route('transport.dashboard', [$langu->Short_name])); ?>"
                                        class="menu-link d-flex px-5 <?php echo e(Request()->lang == $langu->Short_name ? 'active' : ''); ?>">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src="<?php echo e(asset('logo/' . $langu->logo)); ?>"
                                                alt="<?php echo e($langu->language_name); ?>" />
                                        </span><?php echo e($langu->language_name); ?></a>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <!--end::Menu item-->
                        </div>
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="<?php echo e(url('logout')); ?>" class="menu-link px-5">Sign Out</a>
                    </div>
                    <!--end::Menu item-->
                </div>
...
<?php /**PATH D:\xampp\htdocs\eld_new_soff\resources\views/transport/layout/navbar.blade.php ENDPATH**/ ?>