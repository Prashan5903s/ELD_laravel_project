                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="<?php echo e(route('white-label.dashboard')); ?>"
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" kt_ec_tr_table-toolbar="base">
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    ...
                                                    onclick="window.location.href='<?php echo e(route('transport.add')); ?>'">
                                                ...
                                                <tbody class="text-gray-600 fw-semibold" id="userTableBody">
                                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                                ...
                                                                <div
                                                                    class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                        ...
                                                                        <div class="symbol-label">
                                                                            <img src="<?php echo e(!empty($value->avatar_image) ? asset('transportFolder/' . $value->avatar_image) : asset('assets/img/profile.jpg')); ?>"
                                                            ...
                                                            <td><?php echo e(trim(explode(',', $value->country_code)[0])); ?> <?php echo e($value->mobile_no); ?></td>
                                                            <td>
                                                            ...
                                                            <td class="text-end">
                                                                ...
                                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                    ...
                                                                    <div class="menu-item px-3">
                                                                        <a href="<?php echo e(url('transport/edit/' . $value->id)); ?>"
...
<?php $__env->startSection('footer-script-link'); ?>
    <script src="<?php echo e(asset('assets/js/custom/apps/superAdmin/ec/tr/list.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('company.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\eld_new_soff\resources\views/company/transport/index.blade.php ENDPATH**/ ?>