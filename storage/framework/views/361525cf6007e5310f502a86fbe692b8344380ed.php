<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <!--begin::Logo-->
            <a href="<?php echo e(url('admin/dashboard')); ?>" class="app-sidebar-logo">
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6">
                ...
                <div class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative"
                    ...
                    <span
                        class="position-absolute top-0 start-100 translate-middle badge badge-circle badge-danger w-15px h-15px ms-n4 mt-3"><?php echo e($unreadNotificationsCount); ?></span>
                </div>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true"
                    ...
                    <div class="d-flex flex-column bgi-no-repeat rounded-top"
                        style="background-image:url(<?php echo e(url('assets/media/misc/menu-header-bg.jpg')); ?>)">
                        <!--begin::Title-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                ...
                                                <a href="#"
                                                    class="fs-6 text-gray-800 text-hover-primary fw-bold"><?php echo e($notification->title); ?></a>
                                                <div class="text-gray-500 fs-7"><?php echo e($notification->data['message']); ?>
                                        ...
                                        <span
                                            class="badge badge-light fs-8"><?php echo e($notification->created_at->diffForHumans()); ?></span>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px"
                    ...
                    <?php if(session('avatar')): ?>
                        <img src="<?php echo e(asset('admin/' . session('avatar'))); ?>" alt="user" />
                    <?php else: ?>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <!--begin::Username-->
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5"><?php echo e(session('first')); ?>

                                    <?php echo e(session('last')); ?>

                                </div>
                                <a href="#"
                                    class="fw-semibold text-muted text-hover-primary fs-7"><?php echo e(session('email')); ?></a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="<?php echo e(route('admin.profile.index')); ?>" class="menu-link px-5">My Profile</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="<?php echo e(route('admin.profile.edit')); ?>" class="menu-link px-5">Edit Profile</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
...
<?php /**PATH D:\xampp\htdocs\eld_new_soff\resources\views/super-admin/layout/navbar.blade.php ENDPATH**/ ?>