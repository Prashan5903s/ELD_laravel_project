<script>
    var hostUrl = "<?php echo e(url('assets/')); ?>";
</script>
...
<script src="<?php echo e(url('assets/js/custom/apps/ecommerce/catalog/products.js')); ?>"></script>
...
<script src="<?php echo e(url('assets/js/custom/utilities/modals/create-campaign.js')); ?>"></script>
...
<?php echo $__env->yieldContent('foooter-all-script'); ?>
<script>
    toastr.options = {
        "closeButton": true,
        "debug": false,
...
<?php /**PATH D:\xampp\htdocs\eld_new_soff\resources\views/super-admin/layout/footer.blade.php ENDPATH**/ ?>