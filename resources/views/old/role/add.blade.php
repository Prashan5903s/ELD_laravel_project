                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <!--begin::Form-->
                                <form id="kt_ecommerce_add_product_form" method="POST" action="{{ url('role/add/post') }}"
                                    ...
                                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                        ...
                                        <div class="card card-flush py-4">
                                            <!--begin::Card header-->
                                            <div class="pl-5"> Add Role here</div>
                                            <!--begin::Card body-->
                                                ...
                                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                                    ...
                                                    <div class="card card-flush py-4">
                                                        ...
                                                        <div class="card-body pt-0">
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                <label class="required form-label">Select status</label>
                            ...
                            <script>
                                $(document).ready(function() {
                                    $('#yourFormId').submit(function(e) {
                                        ...
                                        if ($('#kt_ecommerce_add_product_status_select').val() === '') {
