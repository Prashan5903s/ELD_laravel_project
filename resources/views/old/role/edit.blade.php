                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                            ...
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{url('role/add')}}" class="text-muted text-hover-primary">Add</a>
                                            </li>
                                            <!--end::Item-->
                                        </ul>
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <form id="kt_ecommerce_add_product_form" method="POST"
                                    action="{{ url('role/editForm/' . $role->id) }}" class="form d-flex flex-column flex-lg-row"
                                        ...
                                        <ul
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link text-active-primary pb-4 active"
                                                    data-bs-toggle="tab"
                                                    href="#kt_ecommerce_add_product_general">Role</a>
                                            </li>
                                            <!--end:::Tab item-->
                                            <!--begin:::Tab item-->
                                                    ...
                                                    <div class="card card-flush py-4">
                                                        ...
                                                        <div class="card-body pt-0">
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <!--end::Input-->
                                                                <!--begin::Description-->
                                                                <div class="text-muted fs-7">A role name is required
                                                            ...
                                                            <div>
                                                                ...
                                                                <!--begin::Editor-->
                                                                <textarea name="description" class="form-control mb-2" placeholder="Description ">{{$role->description}}</textarea>
