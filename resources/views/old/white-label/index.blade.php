                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    ...
                                                    onclick="window.location.href='{{ url('white-label/add') }}'">
...
<img src="{{ !empty($value->avatar_image) ? asset('whiteLabel/' . $value->avatar_image) : asset('assets/img/profile.jpg') }}" alt="{{ $value->first_name }}" class="w-100" />
...
<td>{{ \Carbon\Carbon::parse($value->created_at)->format('h:i A d-m-Y') }}</td>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="{{url('white-label/edit/' . $value->id)}}"
