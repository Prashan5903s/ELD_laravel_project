<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <!--begin::Logo-->
            <a href="{{ url('white-label/dashboard') }}" class="app-sidebar-logo">
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            <div class="app-navbar-item d-flex align-items-stretch flex-lg-grow-1">
                <!--begin::Search-->
                <div id="kt_header_search" class="header-search d-flex align-items-center w-lg-350px order-lg-first order-last"
                    ...
                    @if (session()->has('ut') && session('ut') == 1)
                        <div class="warning-msg d-flex align-items-center">
                            ...
                            <div class="warning-icon me-2 ms-4">
                                <i class="fas fa-exclamation-triangle" data-bs-toggle="popover" data-bs-custom-class="d-sm-none" data-bs-template='<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body text-danger"></div></div>' data-bs-content="You have shadow logged in {{ auth()->user()->first_name }}
                                {{ auth()->user()->last_name }}'s white label
                                account." style="color: red; font-size: 18px;"></i>
                            </div>
                            <!-- Warning Message -->
                            ...
                            <div class="app-navbar-item ms-2">
                                <!--begin::Link-->
                                <a href="{{ route('wc.user.change', ['SA', 4]) }}"
            ...
            <div class="app-navbar-item ms-2 ms-lg-6 me-lg-13" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px"
                    ...
                    @if (session('avatar'))
                        <img src="{{ asset('whiteLabel/' . session('avatar')) }}" alt="user" />
                    @else
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a href="#"
                                    class="fw-semibold text-muted text-hover-primary fs-7" style="overflow-wrap:anywhere">{{ session('email') }}</a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
