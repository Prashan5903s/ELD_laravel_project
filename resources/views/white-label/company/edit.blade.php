                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{ url('white-label/dashboard') }}"
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{ route('company.index') }}"
                                                    class="text-muted text-hover-primary">Company</a>
                                            </li>
                                            <!--end::Item-->
                                        </ul>
                                        <!--end::Breadcrumb-->
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <!--begin::Form-->
                                <form method="POST" action="{{ url('company/post/' . $user->id) }}"
                                    id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                                    data-kt-redirect="{{ route('company.index') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="card-body text-center pt-0">
                                                ...
                                                <style>
                                                    .image-input-placeholder {
                                                        background-image: url('{{ !empty($user->avatar_image) ? asset("companyss/$user->avatar_image") : asset('assets/media/svg/files/blank-image.svg') }}');
                                                    }

                                                    [data-bs-theme="dark"] .image-input-placeholder {
                                                        background-image: url('{{ !empty($user->avatar_image) ? asset("companyss/$user->avatar_image") : asset('assets/media/svg/files/blank-image-dark.svg') }}');
                                                    }
                                                </style>
                                                    ...
                                                    <div class="card card-flush py-4">
                                                        ...
                                                        <div class="card-body pt-0">
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <select name="lead_by" class="form-control mb-2"
                                                                    id="lead_by">
                                                                    <option value="">Select Reseller</option>
                                                                    @foreach ($reseller as $resellers)
                                                                        <option value="{{ $resellers->id }}"
                                                                            {{ $user->lead_by == $resellers->id ? 'selected' : '' }}>
                                                                            {{ $resellers->first_name }}
                                                                            {{ $resellers->last_name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
