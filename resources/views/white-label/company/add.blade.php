                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{ route('company.add') }}"
                                                    class="text-muted text-hover-primary">Add</a>
                                            </li>
                                            <!--end::Item-->
                                        </ul>
                                        <!--end::Breadcrumb-->
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <!--begin::Form-->
                                <form method="POST" action="{{ route('company.addForm') }}"
                                                        ...
                                                        <div class="card-body pt-0">
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <select name="lead_by" class="form-control mb-2"
                                                                    id="lead_by" data-control="select2"
                                                                    data-placeholder="Select a Reseller">
                                                                    <option></option>
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <select name="hardware_id" class="form-control mb-2"
                                                                    id="hardware_id" data-control="select2"
                                                                    data-placeholder="Select Hardware" required>
                                                                    <option></option>
