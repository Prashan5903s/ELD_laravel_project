                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                        ...
                                        <div class="d-flex flex-wrap flex-sm-nowrap">
                                            ...
                                            <div class="me-7 mb-4">
                                                <div
                                                    ...
                                                    <img src="{{ asset('admin/' . $user->avatar_image) }}"
                                                         alt="{{ $user->first_name }} {{ $user->last_name }}" />
                                                @else
                                                    <img src="{{ asset('assets/img/image.jpg') }}" alt="{{ $user->first_name }} {{ $user->last_name }}" />
                                                @endif
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                            <a href="#"
                                                                ...
                                                                <i
                                                                    class="ki-outline ki-profile-circle fs-4 me-1"></i>Admin</a>
                                                            <a href="#"
                                                                class="d-flex align-items-center text-gray-500 text-hover-primary me-5 mb-2">
                                                                <i
                                                                    class="ki-outline ki-geolocation fs-4 me-1"></i>{{ $user->address }}</a>
                                                            <a href="#"
                                                                Fclass="d-flex align-items-center text-gray-500 text-hover-primary mb-2">
                                                                <i
                                                                    class="ki-outline ki-sms fs-4"></i>{{ $user->email }}</a>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                    <!--end::User-->
                                ...
                                <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                    ...
                                    <div class="card-header cursor-pointer">
                                        ...
                                        <!--end::Card title-->
                                        <!--begin::Action-->
                                        <a href="{{route('white-label.profile.edit')}}"
                                    ...
                                    <div class="card-body p-9">
                                        ...
                                        <div class="row mb-7">
                                            ...
                                            <div class="col-lg-8 fv-row">
                                                <span class="fw-semibold text-gray-800 fs-6">{{$user->comp_name}}</span>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row mb-7">
                                            ...
                                            <div class="col-lg-8 d-flex align-items-center">
                                                <span class="fw-bold fs-6 text-gray-800 me-2">{{$user->mobile_no}}</span>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row mb-7">
                                            <!--begin::Label-->
                                            <label class="col-lg-4 fw-semibold text-muted">No of reseller
                                                <span class="ms-1" data-bs-toggle="tooltip"
                                                    title="Phone number must be active">
                                                </span></label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8 d-flex align-items-center">
                                                <span class="fw-bold fs-6 text-gray-800 me-2">{{$resellerCount}}</span>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <div class="row mb-7">
                                            <!--begin::Label-->
                                            <label class="col-lg-4 fw-semibold text-muted">No of company
                                                <span class="ms-1" data-bs-toggle="tooltip"
                                                    title="Phone number must be active">
                                                </span></label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8 d-flex align-items-center">
                                                <span class="fw-bold fs-6 text-gray-800 me-2">{{$companyCount}}</span>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <div class="row mb-7">
                                            <!--begin::Label-->
                                            <label class="col-lg-4 fw-semibold text-muted">No of transport
                                                <span class="ms-1" data-bs-toggle="tooltip"
                                                    title="Phone number must be active">
                                                </span></label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8 d-flex align-items-center">
                                                <span class="fw-bold fs-6 text-gray-800 me-2">{{$transportCount}}</span>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                    </div>
                            ...
                            <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                                ...
                                <li class="menu-item">
                                    <a href="https://devs.keenthemes.com" target="_blank"
                                        class="menu-lin k px-2">Support</a>
                                </li>
                                <li class="menu-item">
