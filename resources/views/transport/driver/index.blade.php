                                            ...
                                            <div class="d-flex justify-content-end" data-kt_tr_u_table-toolbar="base">
                                                ...
                                                @if ($permissions->contains(10))
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        ...
                                                        onclick="window.location.href='{{ route('driver.auth.add', [request()->lang]) }}'">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_tr_u_table">
                                                <thead>
                                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        <th class="min-w-125px">@lang('lang.user')</th>
                                                        <th class="min-w-125px">@lang('lang.mno')</th>
                                                        <th class="min-w-125px">@lang('lang.status')</th>
                                                        <th class="min-w-125px">@lang('lang.jdate')</th>
                                                ...
                                                <tbody class="text-gray-600 fw-semibold" id=userTableBody>
                                                    @foreach ($users as $value)
                                                        <tr>
                                                            <td class="d-flex align-items-center">
                                                                <div
                                                                    ...
                                                                    <div class="symbol-label">
                                                                        <img src="{{ !empty($value->avatar_image) ? asset('driverss/' . $value->avatar_image) : asset('assets/img/profile.jpg') }}"
                                                                            alt="{{ $value->first_name }}" class="w-100" />
                                                                    </div>

                                                                </div>
                                                                <div class="d-flex flex-column">
                                                                    <a href="{{ route('driver.driver_detail', [request()->lang, $value->id]) }}"
                                                            ...
                                                            <td>{{ trim(explode(',', $value->country_code)[0]) }}
                                                                {{ $value->mobile_no }}</td>
                                                            <td>
                                                                ...
                                                                <td class="text-end">
                                                                    ...
                                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                        ...
                                                                        <div class="menu-item px-3">
                                                                            <a href="{{ route('driver.auth.edit', [request()->lang, $value->id]) }}"
