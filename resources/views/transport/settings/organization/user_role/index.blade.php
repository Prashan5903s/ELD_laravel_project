                                                    ...
                                                    <div class="card-body pt-1">
                                                        ...
                                                        @if (isset($role->permissions) && count($role->permissions) > 0)
                                                            ...
                                                            @if (count($role->permissions) > 5)
                                                                <div class='d-flex align-items-center py-2'>
                                                                    <span class='bullet bg-primary me-3'></span>
                                                                    <em>and {{ count($role->permissions) - 5 }}
                                                                        more...</em>
                                                                </div>
                                                            @endif
                                                        </div>
                                                ...
                                                @if ($role->master_id != 0)
                                                    @if ($permissions->contains(25))
                                                        <div class="card-footer flex-wrap pt-0">
                                                            ...
                                                            <a href="{{ route('settings.organisation.userRoles.edit', [request()->lang, $role->id]) }}"
                                    ...
                                    <div class="ol-md-4">
                                        ...
                                        <div class="card h-md-100">
                                            ...
                                            <div class="card-body d-flex flex-center">
                                                <!--begin::Button-->
                                                <a href="{{ route('settings.organisation.userRoles.create', [request()->lang]) }}"
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                    ...
                                                    <div class="fv-row mb-10">
                                                        ...
                                                        <input class="form-control form-control-solid"
                                                            placeholder="Enter a role name" name="role_name" required />
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Permissions-->
