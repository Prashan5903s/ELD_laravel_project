                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        <!--begin::Title-->
                                        <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">Edit a Role</h1>
                                        <!--end::Title-->
                                        <!--begin::Breadcrumb-->
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{ route('transport.dashboard', [request()->lang]) }}" class="text-muted text-hover-primary">Home</a>
                                            </li>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            ...
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{ route('transport.dashboard', [request()->lang]) }}" class="text-muted text-hover-primary">@lang('lang.user_role')</a>
                                            </li>
                                            <!--end::Item-->
                                        </ul>
                                        <!--end::Breadcrumb-->
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <div>
                                    <!--begin::Form-->
                                    <form class="form" action="{{ route('settings.organisation.userRoles.update', [request()->lang, $role->id]) }}" method="POST">
                                        @csrf
                                        @method('put')
                                        <!--begin::Scroll-->
                                        <div class="d-flex flex-column overflow-auto me-n7 pe-7" id="kt_modal_add_role_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_role_header" data-kt-scroll-wrappers="#kt_modal_add_role_scroll" data-kt-scroll-offset="300px">
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input class="form-control form-control-solid" placeholder="Enter a role name" name="name" value="{{ $role->name }}" required/>
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                            <!--begin::Permissions-->
                                                            ...
                                                            <div class="permissionSection">
                                                                ...
                                                                <div class="d-flex flex-wrap border-bottom-dashed border-bottom">
                                                                    ...
                                                                    <div class="col-lg-3 pe-3 py-5">
                                                                        <label class="form-check form-check-custom form-check-solid me-9 cursor-pointer">
                                                                            <input class="form-check-input" type="checkbox" value="{{ $permission->id }}" onchange="isChecked();" name="permissions[]" {{ $role->hasPermission($permission->name) ? 'checked' : '' }} id="{{ Str::snake($permission->name) }}">
