                                            ...
                                            <div class="d-flex justify-content-end" data-kt_tr_u_table-toolbar="base">
                                                ...
                                                @if ($permissions->contains(30))
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                        ...
                                                        onclick="window.location.href='{{ route('driver.activity.create', [request()->lang]) }}'">
                                                        <i class="ki-outline ki-plus fs-2"></i>Add @lang('lang.dactivity')
                                                    </button>
                                                @endif
                                                <!--end::Add user-->
                                            </div>
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_tr_u_table">
                                                <thead>
                                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="min-w-125px">Vechile name</th>
                                                        <th class="min-w-125px">Current driving status</th>
                                                        <th class="min-w-125px">Message reason</th>
                                                        <th class="min-w-125px">Status</th>
                                                        <th class="min-w-125px">Shift change time</th>
                                                        @if ($permissions->contains(31))
                                                            <th class="text-end min-w-100px">@lang('lang.action')</th>
                                                        @endif
                                                    </tr>
                                                </thead>
                                                <tbody class="text-gray-600 fw-semibold" id=userTableBody>
                                                    @foreach ($driverShift as $value)
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                {{ Str::words($value->message_reason, 5, '...') }}
                                                            </td>
                                                            <td>
                                                                ...
                                                                <td class="text-end">
                                                                    ...
                                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                        ...
                                                                        <div class="menu-item px-3">
                                                                            <a href="{{ route('driver.activity.edit', [request()->lang, $value->id]) }}"
...
@section('footer-script-link')
    <script src="{{ asset('assets/js/custom/apps/superAdmin/tr/driverActivity/list.js') }}"></script>
@endsection
