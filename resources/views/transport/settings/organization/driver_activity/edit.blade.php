                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <!--begin::Form-->
                                <form method="POST"
                                    action="{{ route('driver.activity.update', [request()->lang, $log->id]) }}"
                                                    ...
                                                    <div class="card card-flush py-4">
                                                        <div class="card-body pt-0">
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <select name="driver_status" id="driverStatus" required
                                                                    ...
                                                                    @foreach ($listOption as $value)
                                                                        <option
                                                                            {{ $log->option->option_id == $value->option_id ? 'selected' : '' }}
                                                            ...
                                                            <div class="mb-3 fv-row" id="messageReasonContainer"
                                                                style="display:none;">
                                                                <label for="messageReason"
                                                                    class="required form-label">Message reason</label>
                                                                <textarea name="message_reason" id="messageReason" class="form-control" cols="10" rows="5">{{ $log->message_reason }}</textarea>
...
@section('footer-script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleMessageReasonContainer() {
                if (driverStatus.value == '5') {
            ...
            // Set initial visibility based on the default selected status
            toggleMessageReasonContainer();

            driverStatus.addEventListener('change', toggleMessageReasonContainer);
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            driverSelect.addEventListener('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        defaultOption.value = ""; // Set value as empty
                        defaultOption.textContent =
                            "Select Vehicle"; // Set text as "Select Vehicle"
                        ...
                        if (response.length === 0) {
                            ...
                            response.forEach(function(vehicle) {
                                ...
                                // Check if the current vehicle ID matches the default vehicle ID
                                if ({{ $log->vehicle->id }} == vehicle.id) {
                                    option.selected =
                                        true; // Set this option as selected
                                }
            ...
            // Trigger change event on driver select to load vehicles for default selected driver
