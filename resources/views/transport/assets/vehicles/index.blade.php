                            ...
                            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                        ...
                                        <li class="breadcrumb-item text-muted">@lang('lang.vehicles')</li>
                                ...
                                <div class="card-header mt-6">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <button type="button" class="btn btn-light-primary" data-bs-toggle="modal"
                                            ...
                                            <i class="ki-outline ki-plus-square fs-3"></i>@lang('lang.addV')</button>

                                        {{-- <a href="{{ route('vehicles.create') }}" class="btn btn-light-primary">

                                        <i class="ki-outline ki-plus-square fs-3"></i>Add Vehicle</a> --}}
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0"
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-125px">@lang('lang.vin')</th>

                                                <th class="min-w-125px">@lang('lang.make')</th>

                                                <th class="min-w-125px">@lang('lang.model')</th>

                                                <th class="min-w-125px">@lang('lang.year')</th>
                                                ...
                                                <th class="min-w-125px">@lang('lang.licensePlate')</th>
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                @if ($value->option_id == $vehicle->make)

                                                <td data-make={{ $vehicle->make }}>{{ $value->title }}
                                                ...
                                                @if ($values->option_id == $vehicle->fuel_type)

                                                <td data-fuel={{ $vehicle->fuel_type }}>
                                                ...
                                                @if ($value->state_id == $vehicle->license_state)

                                                <td data-state={{ $value->state_id }}>
                                                ...
                                                <td>{{ $vehicle->fuel_tank_primary }}</td>

                                                <td>{{ $vehicle->fuel_tank_secondary }}</td>

                                                @foreach ($throttle_wifi as $key => $value)

                                                @if ($key == $vehicle->throttle_wifi)
                                                ...
                                                <td>
                                                    ...
                                                    <div
                                                        ...
                                                        class="badge badge-light-{{ $vehicle->status ? 'success' : 'danger' }}">

                                                        {{ $vehicle->status ? __('lang.active') : __('lang.deActive') }}

                                                    </div>

                                                </td>

                                                <td>{{ date('d M Y, h:i a', strtotime($vehicle->created_at)) }}
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <button
                                                        ...
                                                        data-url="{{ isset(request()->lang) ? route('vehicles.update', [request()->lang, $vehicle->id]) : route('vehicles.update', ['en', $vehicle->id]) }}"
                                                    ...
                                                    <label class="form-switch form-check-solid">
                                                        ...
                                                        <input class="form-check-input border" type="checkbox"
                                                            ...
                                                            data-url="{{ isset(request()->lang) ? route('vehicles.destroy', [request()->lang, $vehicle->id]) : route('vehicles.destroy', ['en', $vehicle->id]) }}"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h2 class="fw-bold">@lang('lang.addAVehicle')</h2>
                    ...
                    <form id="kt_modal_add_vehicle_form" class="form" action="#" method="post">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <label class="fs-6 fw-semibold form-label mb-2">
                                ...
                                <span class="required">@lang('lang.vin')</span>
                            ...
                            <input class="form-control form-control-solid" placeholder="@lang('lang.enterVIN')"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <label class="fs-6 fw-semibold form-label mb-2">
                                ...
                                <span class="required">@lang('lang.make')</span>
                            ...
                            <select class="form-select form-select-solid" name="make"
                                ...
                                data-placeholder="@lang('lang.selectOption')">

                                <option></option>

                                @foreach ($make as $value)

                                <option value="{{ $value->option_id }}">{{ $value->title }}</option>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <label class="fs-6 fw-semibold form-label mb-2">
                                ...
                                <span class="required">@lang('lang.model')</span>
                            ...
                            <input class="form-control form-control-solid" placeholder="@lang('lang.enterModel')"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <label class="fs-6 fw-semibold form-label mb-2">
                                ...
                                <span class="required">@lang('lang.year')</span>
                            ...
                            <select class="form-select form-select-solid" name="year"
                                ...
                                @foreach (range($vehicle_year, date('Y')) as $year)
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <label class="fs-6 fw-semibold form-label mb-2">
                                ...
                                <span class="required">@lang('lang.licensePlate')</span>
                            ...
                            <input class="form-control form-control-solid" placeholder="@lang('lang.enterLicense')"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h2 class="fw-bold">@lang('lang.updateVehicle')</h2>
                ...
                validator.validate().then(function(status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        $.ajax({
                            ...
                            url: "{{ isset(request()->lang) ? route('vehicles.store', request()->lang) : route('vehicles.store', 'en') }}",
