            ...
            <div class="d-flex flex-column flex-column-fluid">
               ...
               <div id="kt_app_content" class="app-content flex-column-fluid">
                  ...
                  <div id="kt_app_content_container" class="app-container container-fluid">
                     <!--begin::Form-->
                     <form method="POST" action="{{route('leadby.addForm')}}"
                        id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                        data-kt-redirect="{{route('leadby.index')}}" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                           ...
                           <div class="card card-flush py-4">
                              ...
                              <div class="card-body text-center pt-0">
                                 ...
                                 <!--end::Image input-->
                                 <!--begin::Description-->
                                 <div class="text-muted fs-7">Set the lead by profile image. Only *.png,
                                       ...
                                       <div class="card-body pt-0">
                                          ...
                                          <div class="mb-10 fv-row">
                                             ...
                                             <div class="input-group">
                                                <input id="password" type="password" name="password" class="form-control mb-2" placeholder="Password" value="" required />
                                          ...
                                          <div class="mb-10 fv-row">
                                             ...
                                             <div class="input-group">
                                                <input id="confirm_password" type="password" name="confirm_password" class="form-control mb-2" placeholder="Confirm Password" value="" required />
                                                <div class="input-group-append">
