@extends('reseller.layout.index')
@section('main-reseller-container')
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <!--begin::Header-->
            @include('reseller.layout.navbar')
            <!--end::Header-->
            <!--begin::Wrapper-->
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                <!--begin::Sidebar-->
                @include('reseller.layout.left-slidebar')
                <!--end::Sidebar-->
                <!--begin::Main-->
                            ...
                            <div id="kt_app_toolbar_container"
                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        <!--begin::Title-->
                                        <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0"> Lead by List</h1>
                                        <!--end::Title-->
                                        <!--begin::Breadcrumb-->
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{route('reseller.dashboard')}}" class="text-muted text-hover-primary">Home</a>
                                            </li>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            ...
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{route('leadby.index')}}" class="text-muted text-hover-primary">
                                                    Lead By
                                                </a>
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <div class="card">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    ...
                                                    onclick="window.location.href='{{route('leadby.add')}}'">
                                                    <i class="ki-outline ki-plus fs-2"></i>Add Lead by
                                                </button>
                                                <!--end::Add user-->
                                            </div>
                                            <!--end::Toolbar-->
                                    ...
                                    <div class="card-body py-4">
                                        <!--begin::Table-->
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users userTable">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                            <a href="apps/user-management/users/view.html">
                                                                <div class="symbol-label">
                                                                    <img src="{{ !empty($value->avatar_image) ? asset('leadby/' . $value->avatar_image) : asset('assets/img/profile.jpg') }}" alt="{{ $value->first_name }}" class="w-100" />
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <a href="apps/user-management/users/view.html"
                                                                class="text-gray-800 text-hover-primary mb-1">{{$value->first_name}} {{$value->last_name}}</a>
                                                    ...
                                                    <td>
                                                        <div class="badge badge-light fw-bold">{{$value->mobile_no}}</div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a href="{{url('leadby/edit/'  . $value->id)}}"
                        ...
                        <script>
                            $(document).ready(function () {
                                ...
                                $('#searchInput').on('input', function () {
                                    var searchTerm = $(this).val().trim(); // Trim to remove whitespace
                                    ...
                                    $.ajax({
                                        url: "{{ url('white-label/users/search') }}", // Replace with your controller URL
                                        type: 'GET',
                                        dataType: 'json',
                                        data: {
                                        ...
                                        error: function (xhr, status, error) {
                                            ...
                                            // You can display a more specific error message or handle the error in a different way
                                        }
                                    });
                                });

                                // Function to reload default content when search field is empty
                                function reloadDefaultContent() {
                                    $.ajax({
                                        url: "{{ url('white-label/users/default') }}", // Endpoint to fetch default data
                                        type: 'GET',
                                        dataType: 'json',
                                        success: function (data) {
                                            updateTable(data);
                                        ...
                                        error: function (xhr, status, error) {
                                            console.log(xhr.responseText);
                                            $('#errorMessage').text('An error occurred while fetching default data.');
                                            // Handle error
                                        }
                                    });
                                }
                                ...
                                function updateTable(data) {
                                    ...
                                    $.each(data, function (index, value) {
                                        ...
                                        var avatarSrc = value.avatar_image ? assetBaseUrl + '/whiteLabel/' + value.avatar_image : assetBaseUrl + '/assets/img/profile.jpg';
                                        var statusBadge = value.is_active == 1 ? '<div class="badge badge-light-success">Active</div>' : '<div class="badge badge-light-danger">Inactive</div>';
                                        var editUrl = "{{ url('white-label/edit') }}" + "/" + value.id;
                                        var firstName = value.first_name || '';
                                        var lastName = value.last_name || '';
                                        var email = value.email || '';
                                        var companyName = value.comp_name || '';
                                        var mobileNumber = value.mobile_no || '';
                                        ...
                                        var row = '<tr>' +
                                            ...
                                            '<a href="apps/user-management/users/view.html">' +
                                            '<div class="symbol-label">' +
                                            '<img src="' + avatarSrc + '" alt="' + firstName + '" class="w-100" />' +
                                            '</div>' +
                                            '</a>' +
                                            '</div>' +
                                            '<div class="d-flex flex-column">' +
                                            '<a href="apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">' + firstName + ' ' + lastName + '</a>' +
                                            '<span>' + email + '</span>' +
                                            '</div>' +
                                            '</td>' +
                                            '<td>' + companyName + '</td>' +
                                            '<td>' +
                                            '<div class="badge badge-light fw-bold">' + mobileNumber + '</div>' +
                                            '</td>' +
                                            '<td>' + statusBadge + '</td>' +
                                            '<td>' + createdAt + '</td>' +
                                            '<td class="text-end">' +
                                            '<a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions<i class="ki-outline ki-down fs-5 ms-1"></i></a>' +
