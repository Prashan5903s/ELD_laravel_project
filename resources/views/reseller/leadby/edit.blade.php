            ...
            <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                           ...
                           <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                              ...
                              <li class="breadcrumb-item text-muted">
                                 <a href="{{ url('reseller/dashboard') }}" class="text-muted text-hover-primary">
                                 Home
                                 </a>
                              </li>
                              <!--end::Item-->
               ...
               <div id="kt_app_content" class="app-content flex-column-fluid">
                  ...
                  <div id="kt_app_content_container" class="app-container container-fluid">
                     <!--begin::Form-->
                     <form method="POST" action="{{ url('user/post/' . $user->id) }}"
                        id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                        data-kt-redirect="{{route('user.index')}}" enctype="multipart/form-data">
                              ...
                              <div class="card-body text-center pt-0">
                                 ...
                                 <style>
                                    .image-input-placeholder {
                                        background-image: url('{{ !empty($user->avatar_image) ? asset("leadby/$user->avatar_image") : asset("assets/media/svg/files/blank-image.svg") }}');
                                    }
                                    [data-bs-theme="dark"] .image-input-placeholder {
                                        background-image: url('{{ !empty($user->avatar_image) ? asset("leadby/$user->avatar_image") : asset("assets/media/svg/files/blank-image-dark.svg") }}');
                                    }
                                </style>
