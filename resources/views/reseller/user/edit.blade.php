                                            ...
                                            <div class="card-body text-center pt-0">
                                                ...
                                                <style>
                                                    .image-input-placeholder {
                                                        background-image: url('{{ !empty($user->avatar_image) ? asset("userss/$user->avatar_image") : asset('assets/media/svg/files/blank-image.svg') }}');
                                                    }

                                                    [data-bs-theme="dark"] .image-input-placeholder {
                                                        background-image: url('{{ !empty($user->avatar_image) ? asset("userss/$user->avatar_image") : asset('assets/media/svg/files/blank-image-dark.svg') }}');
                                                    }
                                                </style>
