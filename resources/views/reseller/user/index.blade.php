                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-titl">
                                            ...
                                            <div class="d-flex align-items-center position-relative my-1">
                                                ...
                                                <input type="text" id="searchInput" data-kt-rs-u-table-filter="search"
                                                                ...
                                                                <div
                                                                    class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                                        ...
                                                                        <div class="symbol-label">
                                                                            <img src="{{ !empty($value->avatar_image) ? asset('userss/' . $value->avatar_image) : asset('assets/img/profile.jpg') }}"
...
@section('footer-script-link')
    <script src="{{ asset('assets/js/custom/apps/superAdmin/rs/u/list.js') }}"></script>
@endsection
