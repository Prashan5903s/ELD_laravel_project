                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-wc-table-toolbar="base">
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    ...
                                                    onclick="window.location.href='{{ route('device.admin.data.create') }}'">
                                                    <i class="ki-outline ki-plus fs-2"></i>Add device
                                                </button>
                                                <!--end::Add user-->
                                            </div>
                                            <!--end::Toolbar-->
                                            ...
                                            <div class="table-responsive">
                                                <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                    ...
                                                    <tbody class="text-gray-600 fw-semibold">
                                                        @foreach ($data['device'] as $index => $value)
                                                            <tr>
                                                                <td>
                                                                    {{ $index + 1 }}
                                                                    <!-- Incrementing index by 1 to start from 1 -->
                                                                </td>
                                                                ...
                                                                <td class="text-end">
                                                                    ...
                                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                        ...
                                                                        <div class="menu-item px-3">
                                                                            <a href="{{ route('device.admin.data.edit', [$value->id]) }}"
