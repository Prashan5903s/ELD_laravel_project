                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                            ...
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{ route('device.assign.index') }}"
                                                    class="text-muted text-hover-primary">
                                                    Device Assign
                                                </a>
                                            </li>
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <!--begin::Form-->
                                <form method="POST" action="{{ route('device.assign.update', [$data['userDevice']->id]) }}"
                                    id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                                    data-kt-redirect="{{ route('device.assign.update', [$data['userDevice']->id]) }}"
                                                    ...
                                                    <div class="card card-flush py-4">
                                                        <div class="card-body pt-0">
                                                            <div class="mb-10 fv-row">
                                                                <label class="required form-label">Transport Company</label>
                                                                <select name="user_id" id="driverStatus" required
                                                                    ...
                                                                    @foreach ($data['user'][0] as $value)
                                                                        <option value='{{ $value->id }}'
                                                                            {{ $value->id == $data['userDevice']->user_id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                <label class="required form-label">Device serial
                                                                    number</label>
                                                                <select name="serialNo" data-control="select2"
                                                                    data-placeholder="Select Driver"
                                                                    class="form-control mb-2" required>
                                                                    <option value="" selected disabled>
                                                                        Select serial numbar
                                                                    </option>
                                                                    @foreach ($data['device'] as $value)
                                                                        <option value='{{ $value->serialNo }}'
                                                                            {{ $value->serialNo == $data['userDevice']->serialNo ? 'selected' : '' }}>
                                                                            {{ $value->serialNo }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
