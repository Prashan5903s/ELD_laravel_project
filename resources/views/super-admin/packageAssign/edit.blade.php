                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <!--begin::Form-->
                                <form method="POST" action="{{ route('package.assign.update', [$packAssgn->id]) }}"
                                                    ...
                                                    <div class="card card-flush py-4">
                                                        <div class="card-body pt-0">
                                                                ...
                                                                <select name="user_id" id="driverStatus" required
                                                                    ...
                                                                    @foreach ($user as $value)
                                                                        <option value='{{ $value->id }}'
                                                                            {{ $packAssgn->user_id == $value->id ? 'selected' : '' }}>
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <select name="package_id" data-control="select2"
                                                                    ...
                                                                    @foreach ($package as $value)
                                                                        <option
                                                                            {{ $packAssgn->package_id == $value->id ? 'selected' : '' }}
                                                                            value='{{ $value->id }}'>
                                                                            {{ $value->name }}
                                                                        </option>
                                                                    @endforeach
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <input type="text" placeholder="Selectt the start date"
                                                                    name="start_date" value="{{ $packAssgn->start_date }}"
