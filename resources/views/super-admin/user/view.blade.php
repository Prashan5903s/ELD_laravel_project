                                ...
                                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                                            ...
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-muted">
                                                <a href="{{ route('user.view') }}" class="text-muted text-hover-primary">
                                                    View User
                                                </a>
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                                ...
                                                <tbody class="text-gray-600 fw-semibold">
                                                    @foreach ($users as $user)
                                                        <tr class="parent-item parent-row"data-user-id="{{ $user->id }}"
                                                            ...
                                                            <td>{{ \Carbon\Carbon::parse($user->created_at)->format('h:i A d-m-Y') }}
                                                            </td>
                                                        ...
                                                        @include('super-admin.layout.user_row', [
                                            ...
                                            <script>
                                                $(document).ready(function() {
                                                    ...
                                                    $('#shadowLoginYes').on('click', function() {
                                                        ...
                                                        var routeUrl =
                                                            "{{ route('admin.user.change', ['user_type_placeholder', 'user_id_placeholder']) }}";
