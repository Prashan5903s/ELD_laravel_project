            ...
            <div class="d-flex flex-column flex-column-fluid">
               ...
               <div id="kt_app_content" class="app-content flex-column-fluid">
                  ...
                  <div id="kt_app_content_container" class="app-container container-fluid">
                     <!--begin::Form-->
                     <form method="POST" action="{{ url('admin/profile/post/' . $user->id) }}"
                        id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                        data-kt-redirect="{{route('admin.profile.index')}}" enctype="multipart/form-data">
                              ...
                              <div class="card-body text-center pt-0">
                                 ...
                                 <style>
                                    .image-input-placeholder {
                                        background-image: url('{{ !empty($user->avatar_image) ? asset("admin/$user->avatar_image") : asset("assets/media/svg/files/blank-image.svg") }}');
                                    }
                                    [data-bs-theme="dark"] .image-input-placeholder {
                                        background-image: url('{{ !empty($user->avatar_image) ? asset("admin/$user->avatar_image") : asset("assets/media/svg/files/blank-image-dark.svg") }}');
                                    }
                                </style>
