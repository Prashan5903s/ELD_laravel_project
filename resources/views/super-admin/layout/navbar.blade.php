<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <!--begin::Logo-->
            <a href="{{ url('admin/dashboard') }}" class="app-sidebar-logo">
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 me-2">
                                                ...
                                                <div class="text-gray-500 fs-7">{{ $notification->data['message'] }}
                                                </div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px"
                    ...
                    data-kt-menu-placement="bottom-end">
                    @if (session('avatar'))
                        <img src="{{ asset('admin/' . session('avatar')) }}" alt="user" />
                    @else
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <!--begin::Username-->
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">{{ session('first') }}
                                    {{ session('last') }}
                                </div>
                                <a href="#"
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="{{ route('admin.profile.edit') }}" class="menu-link px-5">Edit Profile</a>
                    </div>
                    <!--end::Menu item-->
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
