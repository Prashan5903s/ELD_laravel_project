                                                        ...
                                                        <div class="card-body pt-0">
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <input type="text" name="language_name"
                                                                    class="form-control mb-2" placeholder="Language name" />
                                                                @error('language_name')
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <div id="imagePreviewContainer" class="mb-3">
                                                                    <img id="imagePreview" height="80" width="90" src="#" alt="Image Preview"
                                                                ...
                                                                @enderror
                                                                <!--end::Description-->
                                                            </div>                                                            <!-- Container to display the selected image -->
