                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end" data-kt-wc-table-toolbar="base">
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    ...
                                                    onclick="window.location.href='{{ url('language/create') }}'">
                                                    <i class="ki-outline ki-plus fs-2"></i>Add Language
                                                </button>
                                                <!--end::Add user-->
                                            </div>
                                            <!--end::Toolbar-->
                                                    ...
                                                    <tbody class="text-gray-600 fw-semibold">
                                                        @foreach ($data as $value)
                                                            <tr>
                                                                ...
                                                                <td><img height="40" width="50" src="{{ asset('logo/' . $value->logo) }}" alt="{{ $value->language_name }}"></td>
                                                                <td>
