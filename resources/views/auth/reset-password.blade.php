...
@section('main-login-container')
                        ...
                        <form class="form w-100" method="POST" action="{{ route('password.store') }}">
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input class="form-control bg-transparent" type="email" name="email"
                                    value="{{ session('emailConf') }}" readonly required autofocus
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Repeat Password-->
                                <input class="form-control bg-transparent" type="password" placeholder="Confirm password"
    ...
    <script src="{{ url('assets/js/custom/authentication/reset-password/new-password.js') }}"></script>
@endsection
