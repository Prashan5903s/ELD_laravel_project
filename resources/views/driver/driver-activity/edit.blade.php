                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                <!--begin::Form-->
                                <form method="POST" action="{{ route('driver.activity.dashboard.update', [$log->id]) }}"
                                    id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                                    data-kt-redirect="{{ route('driver.activity.dashboard.update', [$log->id]) }}"
                                                        ...
                                                        <div class="card-body pt-0">
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <select name="driver_status" id="driverStatus" required
                                                                    ...
                                                                    <option value="" disabled>Select Driver
                                                                        Status</option>
                                                                    @foreach ($listOption as $value)
                                                                        <option
                                                                            {{ $log->current_shift_status == $value->option_id ? 'selected' : '' }}
