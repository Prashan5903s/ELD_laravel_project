                            ...
                            <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
                                ...
                                <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link active" href="{{ url('role') }}">
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link" href="{{url('white-label')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                ...
                                <!--end:Menu item-->
                                <!--begin:Menu item-->
                                <div data-kt-menu-trigger="click" class="menu-item {{ in_array(Route::currentRouteName(), ['roles.index', 'permissions.index']) ? 'show' : '' }} menu-accordion">
                                    <!--begin:Menu link-->
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <i class="ki-outline ki-abstract-26 fs-2"></i>
                                        </span>
                                        <span class="menu-title">Apps11</span>
                                        <span class="menu-arrow"></span>
                                    </span>
                                    <!--end:Menu link-->
                                    <!--begin:Menu sub-->
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <div data-kt-menu-trigger="click" class="menu-item {{ in_array(Route::currentRouteName(), ['roles.index', 'permissions.index']) ? 'show' : '' }} menu-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                <!--begin:Menu item-->
                                                <div data-kt-menu-trigger="click" class="menu-item {{ Route::currentRouteName() == 'roles.index' ? 'show' : '' }} menu-accordion">
                                                    <!--begin:Menu link-->
                                                    <span class="menu-link">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                ...
                                                <!--end:Menu item-->
                                                <!--begin:Menu item-->
                                                <div data-kt-menu-trigger="click" class="menu-item {{ Route::currentRouteName() == 'permissions.index' ? 'show' : '' }} menu-accordion">
                                                    <!--begin:Menu link-->
                                                    <span class="menu-link">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
