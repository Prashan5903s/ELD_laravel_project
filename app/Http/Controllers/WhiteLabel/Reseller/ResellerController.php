...
namespace App\Http\Controllers\WhiteLabel\Reseller;
...
class ResellerController extends Controller
{
    ...
    {
        $users = User::where('user_type', 'RS')->where('master_id', $request->session()->get('ids'))->get();

        return view('white-label.reseller.index', compact('users'));
    }
    ...
    public function add()
    {
        ...
        return view('white-label.reseller.add', compact('countries', 'timezones'));
    }
    public function addForm(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            $request->file->move(public_path('reSellerForlder'), $imageName);
        } else {
            $imageName = null;
        }
        ...
        $message = "New reseller has been added " . Auth::user()->first_name . " " . Auth::user()->last_name;
        $url = route('white-label.dashboard');
        $notification = new NotifyNotification($message, $url);
        $user->notify($notification);

        $request->session()->flash('success', 'Reseller updated successfully.');
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('white-label.reseller.edit', compact('user', 'timezones', 'countries'));
    }
    ...
    public function post(Request $request, $id)
    {
        ...
        $user = User::where('user_type', 'SA')->first();
        $message = "New reseller has been edited " . Auth::user()->first_name . " " . Auth::user()->last_name;
        $url = route('white-label.dashboard');
        $notification = new NotifyNotification($message, $url);
        $user->notify($notification);
