<?php
namespace App\Http\Controllers\API\Driver\Document;
...
class DocumentDriverAPIController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        if ($auth) {
            ...
            if ($user) {
                ...
                $documents = Document::select('id', 'document_type', 'image', 'status', 'created_at', 'id')
    ...
    {
        $document = Document::where('id', $id)->where('driver_id', Auth::user()->id)->first();
